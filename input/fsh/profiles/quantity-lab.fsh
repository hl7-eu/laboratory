...
Parent: Ratio-uv-ips
Id: Ratio-eu-lab
Title: "Ratio (Eu) for lab observations"
Description: "Data type Ratio constrained to use UCUM as the code system for units and optionally share measurement uncertainty"
* ^publisher = "HL7 Europe"
