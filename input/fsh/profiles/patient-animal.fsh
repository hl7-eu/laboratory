...
This profile SHALL NOT be used to identify the species when a specimen is collected from an animal. Animal Specimen are represented by AnimalSpecimenEuLab."""
