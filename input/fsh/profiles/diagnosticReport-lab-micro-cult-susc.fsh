...
Description: "CDiagnosticReport used to represent an entry of a specialized Laboratory Report for representing microbiology culture & susceptibility results, including its context, for the scope of the HL7 Europe project."
