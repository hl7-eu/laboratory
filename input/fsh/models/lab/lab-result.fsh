...
* -> "Observation.conformsTo('http://hl7.eu/fhir/ig/xpandh/StructureDefinition/Observation-results-lab-xpandh')"				
...
* observation -> "Observation.conformsTo('http://hl7.eu/fhir/ig/xpandh/StructureDefinition/Observation-results-lab-xpandh')"				
