...
* group[=].element[=].target.code = #Composition.attester.where(mode='professional').party.resolve().ofType(Practitioner).name					
...
* group[=].element[+].code = #Validator.name					
* group[=].element[=].display = "A.1.7.2 Result validator name"					
* group[=].element[=].target.code = #Composition.attester.where(mode='professional').party.resolve().ofType(PractitionerRole).Practitioner.resolve().name					
* group[=].element[=].target.display = "attester.party.Practitioner.name"					
* group[=].element[=].target.equivalence = #equivalent					
...
* group[=].element[=].target.code = #Composition.attester.where(mode='professional').party.resolve().ofType(PractitionerRole).organization.resolve()					
