...
Alias: $workflow-supportingInfo = http://hl7.org/fhir/StructureDefinition/workflow-supportingInfo|5.2.0
...
Alias: $event-performerFunction = http://hl7.org/fhir/StructureDefinition/event-performerFunction|5.2.0
...
Alias: $iso21090-ADXP-postBox = http://hl7.org/fhir/StructureDefinition/iso21090-ADXP-postBox|5.2.0
Alias: $iso21090-SC-coding = http://hl7.org/fhir/StructureDefinition/iso21090-SC-coding|5.2.0
Alias: $iso21090-uncertainty = http://hl7.org/fhir/StructureDefinition/iso21090-uncertainty|5.2.0
Alias: $iso21090-uncertaintyType = http://hl7.org/fhir/StructureDefinition/iso21090-uncertaintyType|5.2.0
Alias: $patient-birthPlace = http://hl7.org/fhir/StructureDefinition/patient-birthPlace|5.2.0
Alias: $patient-animal = http://hl7.org/fhir/StructureDefinition/patient-animal|5.2.0
Alias: $practitioner-animal = http://hl7.org/fhir/StructureDefinition/practitioner-animalSpecies
